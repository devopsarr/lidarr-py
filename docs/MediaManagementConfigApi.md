# lidarr.MediaManagementConfigApi
...
with lidarr.ApiClient(configuration) as api_client:
    ...
    api_instance = lidarr.MediaManagementConfigApi(api_client)
...
with lidarr.ApiClient(configuration) as api_client:
    ...
    api_instance = lidarr.MediaManagementConfigApi(api_client)
    id = 'id_example' # str | 
    media_management_config_resource = lidarr.MediaManagementConfigResource() # MediaManagementConfigResource |  (optional)
