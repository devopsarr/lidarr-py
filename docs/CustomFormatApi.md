...
[**get_custom_format_schema**](CustomFormatApi.md#get_custom_format_schema) | **GET** /api/v1/customformat/schema | 
...
with lidarr.ApiClient(configuration) as api_client:
    ...
    api_instance = lidarr.CustomFormatApi(api_client)
    custom_format_resource = lidarr.CustomFormatResource() # CustomFormatResource |  (optional)
