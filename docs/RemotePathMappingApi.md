...
with lidarr.ApiClient(configuration) as api_client:
    ...
    api_instance = lidarr.RemotePathMappingApi(api_client)
    remote_path_mapping_resource = lidarr.RemotePathMappingResource() # RemotePathMappingResource |  (optional)
