# lidarr.DownloadClientConfigApi
...
with lidarr.ApiClient(configuration) as api_client:
    ...
    api_instance = lidarr.DownloadClientConfigApi(api_client)
...
with lidarr.ApiClient(configuration) as api_client:
    ...
    api_instance = lidarr.DownloadClientConfigApi(api_client)
    id = 'id_example' # str | 
    download_client_config_resource = lidarr.DownloadClientConfigResource() # DownloadClientConfigResource |  (optional)
