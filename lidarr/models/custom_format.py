...
class CustomFormat(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFormat:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFormat:
        """Create an instance of CustomFormat from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CustomFormat.parse_obj(obj)

        _obj = CustomFormat.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "include_custom_format_when_renaming": obj.get("includeCustomFormatWhenRenaming"),
            "specifications": [ICustomFormatSpecification.from_dict(_item) for _item in obj.get("specifications")] if obj.get("specifications") is not None else None
        })
        return _obj
