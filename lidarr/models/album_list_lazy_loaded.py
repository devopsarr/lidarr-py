...
class AlbumListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlbumListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlbumListLazyLoaded:
        """Create an instance of AlbumListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlbumListLazyLoaded.parse_obj(obj)

        _obj = AlbumListLazyLoaded.parse_obj({
            "value": [Album.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
