...
class AlbumReleaseListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlbumReleaseListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlbumReleaseListLazyLoaded:
        """Create an instance of AlbumReleaseListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlbumReleaseListLazyLoaded.parse_obj(obj)

        _obj = AlbumReleaseListLazyLoaded.parse_obj({
            "value": [AlbumRelease.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
