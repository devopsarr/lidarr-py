...
class RootFolderResource(BaseModel):
    ...
    __properties = ["id", "name", "path", "defaultMetadataProfileId", "defaultQualityProfileId", "defaultMonitorOption", "defaultNewItemMonitorOption", "defaultTags", "accessible", "freeSpace", "totalSpace"]
