...
class MediumResource(BaseModel):
    ...
    __properties = ["mediumNumber", "mediumName", "mediumFormat"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MediumResource:
    ...
    def to_dict(self):
        ...
        if self.medium_name is None:
            _dict['mediumName'] = None

        # set to None if medium_format (nullable) is None
        if self.medium_format is None:
            _dict['mediumFormat'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> MediumResource:
        """Create an instance of MediumResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MediumResource.parse_obj(obj)

        _obj = MediumResource.parse_obj({
            "medium_number": obj.get("mediumNumber"),
            "medium_name": obj.get("mediumName"),
            "medium_format": obj.get("mediumFormat")
        })
        return _obj
