...
class HistoryResource(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "track": TrackResource.from_dict(obj["track"]) if obj.get("track") is not None else None
        })
        return _obj
