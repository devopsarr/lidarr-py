...
class UiConfigResource(BaseModel):
    ...
    expand_album_by_default: Optional[bool]
    expand_single_by_default: Optional[bool]
    expand_epby_default: Optional[bool]
    expand_broadcast_by_default: Optional[bool]
    expand_other_by_default: Optional[bool]
    theme: Optional[str]
    __properties = ["id", "firstDayOfWeek", "calendarWeekColumnHeader", "shortDateFormat", "longDateFormat", "timeFormat", "showRelativeDates", "enableColorImpairedMode", "uiLanguage", "expandAlbumByDefault", "expandSingleByDefault", "expandEPByDefault", "expandBroadcastByDefault", "expandOtherByDefault", "theme"]
    ...
    def from_dict(cls, obj: dict) -> UiConfigResource:
        ...
        _obj = UiConfigResource.parse_obj({
            ...
            "expand_album_by_default": obj.get("expandAlbumByDefault"),
            "expand_single_by_default": obj.get("expandSingleByDefault"),
            "expand_epby_default": obj.get("expandEPByDefault"),
            "expand_broadcast_by_default": obj.get("expandBroadcastByDefault"),
            "expand_other_by_default": obj.get("expandOtherByDefault"),
            "theme": obj.get("theme")
        })
        return _obj
