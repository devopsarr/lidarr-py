...
class TrackListLazyLoaded(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrackListLazyLoaded:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrackListLazyLoaded:
        """Create an instance of TrackListLazyLoaded from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TrackListLazyLoaded.parse_obj(obj)

        _obj = TrackListLazyLoaded.parse_obj({
            "value": [Track.from_dict(_item) for _item in obj.get("value")] if obj.get("value") is not None else None,
