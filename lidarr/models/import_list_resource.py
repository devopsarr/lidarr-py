...
class ImportListResource(BaseModel):
    ...
    should_monitor: Optional[ImportListMonitorType] = Field(default=None, alias="shouldMonitor")
    should_monitor_existing: Optional[StrictBool] = Field(default=None, alias="shouldMonitorExisting")
    should_search: Optional[StrictBool] = Field(default=None, alias="shouldSearch")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "enableAutomaticAdd", "shouldMonitor", "shouldMonitorExisting", "shouldSearch", "rootFolderPath", "monitorNewItems", "qualityProfileId", "metadataProfileId", "listType", "listOrder", "minRefreshInterval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shouldMonitorExisting": obj.get("shouldMonitorExisting"),
            "shouldSearch": obj.get("shouldSearch"),
