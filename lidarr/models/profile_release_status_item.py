...
class ProfileReleaseStatusItem(BaseModel):
    ...
    __properties = ["releaseStatus", "allowed"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProfileReleaseStatusItem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProfileReleaseStatusItem:
        """Create an instance of ProfileReleaseStatusItem from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProfileReleaseStatusItem.parse_obj(obj)

        _obj = ProfileReleaseStatusItem.parse_obj({
