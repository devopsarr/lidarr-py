...
class TrackResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "artistId", "foreignTrackId", "foreignRecordingId", "trackFileId", "albumId", "explicit", "absoluteTrackNumber", "trackNumber", "title", "duration", "trackFile", "mediumNumber", "hasFile", "artist", "ratings"]
