...
class ManualImportApi(object):
    ...
    @validate_arguments
    def create_manual_import(self, manual_import_update_resource : Optional[List[ManualImportUpdateResource]] = None, **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def create_manual_import_with_http_info(self, manual_import_update_resource : Optional[List[ManualImportUpdateResource]] = None, **kwargs):  # noqa: E501
        """create_manual_import  # noqa: E501
    ...
    @validate_arguments
    def list_manual_import(self, folder : Optional[StrictStr] = None, download_id : Optional[StrictStr] = None, artist_id : Optional[StrictInt] = None, filter_existing_files : Optional[StrictBool] = None, replace_existing_files : Optional[StrictBool] = None, **kwargs) -> List[ManualImportResource]:  # noqa: E501
        """list_manual_import  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_manual_import(folder, download_id, artist_id, filter_existing_files, replace_existing_files, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_manual_import_with_http_info(folder, download_id, artist_id, filter_existing_files, replace_existing_files, **kwargs)  # noqa: E501

    @validate_arguments
    def list_manual_import_with_http_info(self, folder : Optional[StrictStr] = None, download_id : Optional[StrictStr] = None, artist_id : Optional[StrictInt] = None, filter_existing_files : Optional[StrictBool] = None, replace_existing_files : Optional[StrictBool] = None, **kwargs):  # noqa: E501
        """list_manual_import  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_manual_import_with_http_info(folder, download_id, artist_id, filter_existing_files, replace_existing_files, async_req=True)
        >>> result = thread.get()
