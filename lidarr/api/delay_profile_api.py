...
class DelayProfileApi(object):
    ...
    @validate_arguments
    def update_delay_profile_reorder(self, id : StrictInt, after_id : Optional[StrictInt] = None, **kwargs) -> None:  # noqa: E501
        """update_delay_profile_reorder  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_delay_profile_reorder(id, after_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_delay_profile_reorder_with_http_info(id, after_id, **kwargs)  # noqa: E501

    @validate_arguments
    def update_delay_profile_reorder_with_http_info(self, id : StrictInt, after_id : Optional[StrictInt] = None, **kwargs):  # noqa: E501
        """update_delay_profile_reorder  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_delay_profile_reorder_with_http_info(id, after_id, async_req=True)
        >>> result = thread.get()
        ...
        # process the query parameters
        _query_params = []
        if _params.get('after_id') is not None:  # noqa: E501
            _query_params.append(('afterId', _params['after_id']))
