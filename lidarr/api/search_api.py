...
class SearchApi:
    ...
    def list_search(
        ...
        _param = self._list_search_serialize(
            term=term,
    ...
    @validate_call
    def list_search_with_http_info(
        self,
        term: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SearchResource]]:
        """list_search
    ...
    @validate_call
    def list_search_without_preload_content(
        self,
        term: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
