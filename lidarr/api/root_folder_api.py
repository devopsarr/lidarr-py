...
class RootFolderApi(object):
    ...
    @validate_arguments
    def update_root_folder(self, id : StrictStr, root_folder_resource : Optional[RootFolderResource] = None, **kwargs) -> RootFolderResource:  # noqa: E501
        """update_root_folder  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_root_folder(id, root_folder_resource, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_root_folder_with_http_info(id, root_folder_resource, **kwargs)  # noqa: E501

    @validate_arguments
    def update_root_folder_with_http_info(self, id : StrictStr, root_folder_resource : Optional[RootFolderResource] = None, **kwargs):  # noqa: E501
        """update_root_folder  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_root_folder_with_http_info(id, root_folder_resource, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_root_folder" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
