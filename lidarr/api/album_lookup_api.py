...
class AlbumLookupApi:
    ...
    def get_album_lookup(
        ...
        _param = self._get_album_lookup_serialize(
            term=term,
    ...
    @validate_call
    def get_album_lookup_with_http_info(
        self,
        term: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_album_lookup_without_preload_content(
        self,
        term: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_album_lookup_serialize(
        self,
        term,
        _request_auth,
        _content_type,
