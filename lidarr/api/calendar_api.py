...
class CalendarApi(object):
    ...
    @validate_arguments
    def get_calendar_by_id(self, id : StrictInt, **kwargs) -> AlbumResource:  # noqa: E501
    ...
    @validate_arguments
    def list_calendar(self, start : Optional[datetime] = None, end : Optional[datetime] = None, unmonitored : Optional[StrictBool] = None, include_artist : Optional[StrictBool] = None, **kwargs) -> List[AlbumResource]:  # noqa: E501
