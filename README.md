...
*AlbumLookupApi* | [**list_album_lookup**](docs/AlbumLookupApi.md#list_album_lookup) | **GET** /api/v1/album/lookup | 
...
*ArtistLookupApi* | [**list_artist_lookup**](docs/ArtistLookupApi.md#list_artist_lookup) | **GET** /api/v1/artist/lookup | 
...
*CustomFormatApi* | [**delete_custom_format_bulk**](docs/CustomFormatApi.md#delete_custom_format_bulk) | **DELETE** /api/v1/customformat/bulk | 
...
*CustomFormatApi* | [**put_custom_format_bulk**](docs/CustomFormatApi.md#put_custom_format_bulk) | **PUT** /api/v1/customformat/bulk | 
